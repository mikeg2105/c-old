...
/* we need to use spintf to create filenames and then use fopen and fprintf  */
    
	    sprintf( filname , "output%d" , irank );
	    fpoint = fopen( filname,"w" );
	    fprintf(fpoint, " hello...." ) ;
